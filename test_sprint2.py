...
def run_sprint_2_test():
    print("[Apex] Locating Micromax Node...")
    ...
    print(f"[Apex] Connected to {port}. Initiating Sprint 2 Diagnostics.\n")
    ...
    with serial.Serial(port, 115200, timeout=1) as ser:
        ...
        print("[Apex] Listening for telemetry for 5 seconds...")
        ...
        print("\n[Apex System] Sprint 2 Diagnostics Complete.")
